...
<head>
 ...
 <body style="background-color: blueviolet"> {{--   class="h-full"    --}}
<div class="flex">

  {{-- Div del menú --}}
  <div class="flex flex-col justify-top mx-24 my-16">
    <div class="input">
    ...
    <div class="flex flex-col mx-96 my-96  " >
      
      <p>hola</p>
      <img src="{{ asset('images/neco.jpg')}}" class="justify-center w-1/2 h-auto"  alt="Neco">
    ...
    <div class="flex flex-col mx-12 my-52">
  ...
  {{-- <div class="flex flex-col w-64 h-screen bg-gray-800">
    <div class="flex items-center justify-center h-16 border-b border-gray-700">
      <h1 class="text-white">Mind U</h1>
    </div>
    <div class="flex flex-col items-center justify-center flex-1 p-4">
      <img src="https://via.placeholder.com/150" class="w-32 h-32 rounded-full" alt="Avatar">
      <h2 class="mt-4 text-white">Nombre de usuario</h2>
      <p class="text-sm text-gray-400">rol</p>
    </div>
    <div class="flex flex-col p-4">
      <a href="#" class="flex items-center justify-between p-2 text-white bg-gray-700 rounded hover:bg-gray-600">
        <span>Dashboard</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
        </svg>
      </a>
      <a href="#" class="flex items-center justify-between p-2 text-white rounded hover:bg-gray-600">
        <span>Projects</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
        </svg>
    ...
    {{-- Este div está dentroflex principal --}}
    
    {{-- Aquí empieza el div del botón para los colores  --}}
    {{-- Aquí termina el div del botón para los colores  --}}
    ...
    {{-- <div class="text-center w-32 h-24 max-w-sm mx-24 my-16 bg-white rounded-xl">
      <button onclick="toggleOptions()" id="iconButton">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-16 h-24">
          <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
      </button>
    </div>

    <div id="options" class="hidden text-center w-32 h-24 max-w-sm bg-white rounded-xl ">
    ...
    {{-- 
      ...
      {{-- <div class="mx-52">
        <img src="https://via.placeholder.com/1000" class="mx-auto">
      </div> --}}
